    ...
    <div className="min-h-screen bg-gradient-to-br from-indigo-500 via-purple-600 to-purple-800">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        <div className="bg-white/95 backdrop-blur-sm rounded-xl shadow-lg border border-white/20 p-4 mb-6">
          <div className="flex flex-col sm:flex-row sm:justify-between sm:items-center gap-4">
            ...
            <button
              ...
              className="bg-gradient-to-r from-red-500 to-red-600 hover:from-red-600 hover:to-red-700 text-white font-medium py-2 px-4 rounded-lg transition-all duration-200 hover:shadow-lg transform hover:-translate-y-0.5"
            >
              Logout
            </button>
          </div>
        ...
        <div className="text-center mb-8">
          <h1 className="text-4xl sm:text-5xl font-bold text-white mb-2 flex items-center justify-center gap-3 flex-wrap">
            <span className="text-4xl sm:text-5xl">🚗</span>
            GPU Traffic Analyzer
          </h1>
          <p className="text-lg text-white/85 font-light">
            Process traffic videos using cloud GPU instances
          </p>
        </div>
        ...
        <div className="grid grid-cols-1 xl:grid-cols-2 gap-6">
          {/* Running Instances */}
          <div className="xl:col-span-2 bg-white/95 backdrop-blur-sm rounded-2xl shadow-xl border border-white/20 p-6 hover:shadow-2xl transition-all duration-300">
            <div className="flex flex-col sm:flex-row sm:justify-between sm:items-center mb-6">
              ...
              <button
                ...
                className={`bg-gradient-to-r from-indigo-500 to-indigo-600 hover:from-indigo-600 hover:to-indigo-700 text-white font-medium py-2 px-4 rounded-lg transition-all duration-200 hover:shadow-lg transform hover:-translate-y-0.5 flex items-center gap-2 ${
                  isLoadingInstances ? "opacity-60 cursor-not-allowed" : ""
                }`}
              >
                {isLoadingInstances && (
            ...
            <div className="overflow-x-auto">
              {isLoadingInstances ? (
                ...
                <div className="text-center py-8 text-gray-600">No active instances.</div>
              ) : (
                <table className="w-full border-collapse bg-white rounded-lg overflow-hidden shadow-sm">
                  <thead>
                    <tr className="bg-gradient-to-r from-indigo-500 to-indigo-600 text-white">
                      ...
                      <th className="px-4 py-3 text-left font-semibold text-sm">IP</th>
                      <th className="px-4 py-3 text-left font-semibold text-sm">Type</th>
                      <th className="px-4 py-3 text-left font-semibold text-sm">Region</th>
                  ...
                  <tbody>
                    {instances.map((i) => {
                      ...
                      return (
                        <tr key={i.id} className="hover:bg-indigo-50/80 transition-colors border-b border-gray-100">
                          ...
                          <td className="px-4 py-3 text-sm text-gray-700">{i.ip || "-"}</td>
                          <td className="px-4 py-3 text-sm text-gray-700">{i.instance_type_name || "-"}</td>
                          <td className="px-4 py-3 text-sm text-gray-700">{i.region_name || "-"}</td>
                          ...
                          <td className="px-4 py-3 text-center">
                            <button
                              ...
                              disabled={busy}
                              className={`bg-gradient-to-r from-red-500 to-red-600 hover:from-red-600 hover:to-red-700 text-white font-medium py-1 px-3 rounded text-xs transition-all duration-200 hover:shadow-md transform hover:-translate-y-0.5 flex items-center gap-1 mx-auto ${
          ...
          <div className="bg-white/95 backdrop-blur-sm rounded-2xl shadow-xl border border-white/20 p-6 hover:shadow-2xl transition-all duration-300">
